<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="./index.html">
                        <img src="{{asset('assets/backend')}}/src/assets/img/cork-logo.png" class="navbar-logo" alt="logo">
                    </a>
                </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a target="_blank" href="{{ asset('assets/backend/layouts/collapsible-menu/app.js') }}documentation/index.html" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a target="_blank" href="{{ asset('assets/backend/layouts/collapsible-menu/app.js') }}documentation/changelog.html" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
