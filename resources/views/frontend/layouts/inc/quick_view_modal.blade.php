                                ...
                                <div class="tab-content product-large-image-list" id="myTabContent">
                                    <div class="tab-pane fade show active" id="single-slide1" role="tabpanel"
                                        ...
                                        <div class="single-product-img img-full">
                                            <img width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product01.webp"
                                                class="img-fluid" alt="">
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="single-slide2" role="tabpanel"
                                        ...
                                        <!--Single Product Image Start-->
                                        <div class="single-product-img img-full">
                                            <img width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product02.webp"
                                                class="img-fluid" alt="">
                                        </div>
                                        <!--Single Product Image End-->
                                    </div>
                                    <div class="tab-pane fade" id="single-slide3" role="tabpanel"
                                        ...
                                        <!--Single Product Image Start-->
                                        <div class="single-product-img img-full">
                                            <img width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product03.webp"
                                                class="img-fluid" alt="">
                                        </div>
                                        <!--Single Product Image End-->
                                    </div>
                                    <div class="tab-pane fade" id="single-slide4" role="tabpanel"
                                        ...
                                        <!--Single Product Image Start-->
                                        <div class="single-product-img img-full">
                                            <img width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product04.webp"
                                                class="img-fluid" alt="">
                                        </div>
                                        <!--Single Product Image End-->
                                    </div>
                                    ...
                                    <div class="nav small-image-slider" role="tablist">
                                        <div class="single-small-image img-full">
                                            <a data-bs-toggle="tab" id="single-slide-tab-1" href="#single-slide1"><img
                                                    width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product01.webp"
                                                    class="img-fluid" alt=""></a>
                                        </div>
                                        <div class="single-small-image img-full">
                                            <a data-bs-toggle="tab" id="single-slide-tab-2" href="#single-slide2"><img
                                                    width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product02.webp"
                                                    class="img-fluid" alt=""></a>
                                        </div>
                                        <div class="single-small-image img-full">
                                            <a data-bs-toggle="tab" id="single-slide-tab-3" href="#single-slide3"><img
                                                    width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product03.webp"
                                                    class="img-fluid" alt=""></a>
                                        </div>
                                        <div class="single-small-image img-full">
                                            <a data-bs-toggle="tab" id="single-slide-tab-4" href="#single-slide4"><img
                                                    width="350" height="350" src="{{asset('assets/frontend')}}/images/products/product04.webp"
                                                    class="img-fluid" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7 col-md-6 col-xs-12">
                            ...
                            <div class="product-feature-details">
                                ...
                                <p class="product-description mb-20">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    ...
                                    minim veniam, quis nostrud exercitation ullamco,Proin lectus ipsum, gravida et
                                    mattis
